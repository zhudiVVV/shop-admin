...
public class PmsBrand implements Serializable {
    ...
    public String getAreaRegion() { return areaRegion; }

    public void setAreaRegion(String areaRegion) { this.areaRegion = areaRegion; }
    ...
    public String toString() {
        ...
        sb.append(", areaRegion=").append(areaRegion);
